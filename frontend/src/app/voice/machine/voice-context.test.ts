...
import { createInitialContext, createNewRequestId, createNewTurnId, type VoiceContext } from './voice-context'
...
describe('createNewTurnId', () => {
  it('should generate unique turnId', () => {
    const id1 = createNewTurnId()
    const id2 = createNewTurnId()
    expect(id1).not.toBe(id2)
  })

  it('should generate turnId with correct prefix', () => {
    const id = createNewTurnId()
